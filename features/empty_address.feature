Feature: registration page
	Scenario Outline:  to verify user gets error for empty address if user didnot enter address
		...
		Then verify user gets empty address error message


		Examples:
   | firstname    | lastname  | Email               | telephone  | fax      | company       | address_2               | city    | state       | ZIP       | country | loginname       | password      | confirmpassword      |
   | jghjahffhs   | fhsdfsk   | dsfsagdsf@gmail.com | 4832453654 | oiasjodj | xcvbxmbvm     | krywqwrsc xz            | bvcbvvx | Maharashtra | 432782468 | India   | hsdandslcsn     | hsdndslcsn    | hsdndslcsn           |
