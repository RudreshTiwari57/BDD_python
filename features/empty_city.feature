Feature: registration page
	Scenario Outline:  to verify user gets empty city error message
		...
		Then verify user gets empy city error message


		Examples:
   | firstname    | lastname  | Email             | telephone  | fax      | company       | address_1            | address_2               | state       | ZIP       | country | loginname      | password      | confirmpassword    |
   | jghjahffhs   | fhsdfsk   | dsfgdsdsf@gmail.com | 4832453654 | oiasjodj | xcvbxmbvm     | weiyowqcxv           | krywqwrsc xz            | Maharashtra | 432782468 | India   | hsdndsdslcsn     | hsdndsdslcsn    | hsdndsdslcsn |
