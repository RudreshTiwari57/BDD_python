Feature: registration page
	Scenario Outline:  to verify user gets enter last name error if user doesnot enter last name
        ...
        Then verify user gets enter last name error


		Examples:
   | firstname |  Email             | telephone    | fax | company | address_1            | address_2               | city    | state    | ZIP      | country | loginname | password | confirmpassword |
