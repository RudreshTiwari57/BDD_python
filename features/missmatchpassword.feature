Feature: registration page
	Scenario Outline:  to verify user gets password mismatch error on entering diffrent pasword and confirm pasword
        ...
        And verify user get password mismatch error
   ...
   | ruddreshe   | tiwdarie   | ruedrh@gmail.com | 34433334324334 | asdrd | jrido     | shdhsddksafhradsbfjhsd | ddsjnfksdjnfkjsdndnrfjnsd | hfsdrfs | Maharashtra | 432782468 | India   | rudjhwar     | rujkdar    | rujkdwar           |
